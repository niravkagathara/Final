...
{/*                                 <th>Edit</th> */}
                        ...
                        <tbody>
                            {products.map((product, index) => (
                                <>
                                    <tr   key={product._id}>
                                            <td onClick={showedit} >{index + 1}</td>
                                        <td onClick={showedit} style={{ height: '15rem', width: '20rem' }}><img src={`https://ecommerce-1mc7.onrender.com/images/${product.imageA}`} alt={product.name} style={{ width: '100px' }} /></td>
                                        <td onClick={showedit} style={{ height: '6rem', width: '18rem' }}>{product.name}</td>
                                        <td onClick={showedit} style={{ height: '6rem', width: '15rem' }}>${product.price}</td>
                                        <td onClick={showedit} style={{ height: '10rem', width: '50rem' }}>{product.category}</td>
                                        <td onClick={showedit} style={{ height: '6rem', width: '10rem' }}>{product.companyname}</td>
